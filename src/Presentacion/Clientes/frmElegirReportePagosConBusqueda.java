 ...
 * @author hecto
 */
public class frmElegirReportePagosConBusqueda extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReportePagosConBusqueda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReportePagosBusqueda = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lblReportePagosPendientes = new javax.swing.JLabel();
        btnReportePagosConFechas = new javax.swing.JPanel();
        ...
        btnReportePagosBusqueda.setBackground(new java.awt.Color(102, 0, 0));
        btnReportePagosBusqueda.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReportePagosBusqueda.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReportePagosBusqueda.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnReportePagosBusquedaFocusGained(evt);
            }
        });
        btnReportePagosBusqueda.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReportePagosBusquedaMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReportePagosBusquedaMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReportePagosBusquedaMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnReportePagosBusquedaMouseReleased(evt);
            }
        });
        btnReportePagosBusqueda.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnReportePagosBusqueda.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReportePagosBusqueda.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));
        ...
        lblReportePagosPendientes.setText("Reporte de Pagos Con Busqueda");
        lblReportePagosPendientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReportePagosPendientesMousePressed(evt);
            }
        });
        btnReportePagosBusqueda.add(lblReportePagosPendientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReportePagosBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 300, 50));

        btnReportePagosConFechas.setBackground(new java.awt.Color(102, 0, 0));
        btnReportePagosConFechas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReportePagosConFechas.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReportePagosConFechas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReportePagosConFechasMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReportePagosConFechasMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReportePagosConFechasMouseEntered(evt);
            }
        });
        btnReportePagosConFechas.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReportePagosConFechas.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReportePagosConFechas.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));
        ...
        lblReportePagosNoRealizados.setText("Reporte de Pagos Con Fechas");
        lblReportePagosNoRealizados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReportePagosNoRealizadosMousePressed(evt);
            }
        });
        btnReportePagosConFechas.add(lblReportePagosNoRealizados, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReportePagosConFechas, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
    ...
    private void btnReportePagosBusquedaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnReportePagosBusquedaFocusGained

    }//GEN-LAST:event_btnReportePagosBusquedaFocusGained

    private void btnReportePagosBusquedaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosBusquedaMouseEntered
        setColor(btnReportePagosBusqueda);
    }//GEN-LAST:event_btnReportePagosBusquedaMouseEntered

    private void btnReportePagosBusquedaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosBusquedaMouseExited
        resetColor(btnReportePagosBusqueda);
    }//GEN-LAST:event_btnReportePagosBusquedaMouseExited

    private void btnReportePagosBusquedaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosBusquedaMousePressed
        Map p = new HashMap();
        
        p.put("busqueda", frmRevisarPagos.txtBuscar.getText());
        JasperReport report;
        JasperPrint print;
        
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_pagos_conbusqueda.jrxml");
    ...
    }//GEN-LAST:event_btnReportePagosBusquedaMousePressed

    private void btnReportePagosBusquedaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosBusquedaMouseReleased

    }//GEN-LAST:event_btnReportePagosBusquedaMouseReleased

    private void btnReportePagosConFechasMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosConFechasMouseEntered
        setColor(btnReportePagosConFechas);
    }//GEN-LAST:event_btnReportePagosConFechasMouseEntered

    private void btnReportePagosConFechasMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosConFechasMouseExited
        resetColor(btnReportePagosConFechas);
    }//GEN-LAST:event_btnReportePagosConFechasMouseExited

    private void btnReportePagosConFechasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosConFechasMousePressed
        Map<String, Object> p = new HashMap<String, Object>();
        
        p.put("fecha1", frmRevisarPagos.fecha1);
        p.put("fecha2", frmRevisarPagos.fecha2);
        JasperReport report;
        JasperPrint print;
        
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_pagos_confecha.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Pagos");
            view.setVisible(true);
    ...
    }//GEN-LAST:event_btnReportePagosConFechasMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReportePagosConBusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReportePagosConBusqueda().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JPanel btnReportePagosBusqueda;
    private javax.swing.JPanel btnReportePagosConFechas;
