 ...
 * @author josug
 */
public class frmFacturasPagadas extends javax.swing.JFrame {
    ...
    public void mostrarBuscar(String buscar) {
        try {
            ...
            miModelo = log.mostrarFactura(buscar);
    ...
    public void ordenarTamaños() {
        ...
        Modelo.getColumn(4).setPreferredWidth(45);
        Modelo.getColumn(4).setResizable(false);
        Modelo.getColumn(5).setPreferredWidth(110);
    ...
    private void initComponents() {
        ...
        jLabel23.setText("PAGADAS");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, 50));

        jLabel24.setFont(new java.awt.Font("Bauhaus 93", 1, 24)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(204, 204, 204));
        jLabel24.setText("FACTURAS");
        jPanel2.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, -1, 50));
        ...
        tblFacturas.setSelectionBackground(new java.awt.Color(122, 72, 221));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFacturasPagadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmFacturasPagadas().setVisible(true);
            }
        });
    }
