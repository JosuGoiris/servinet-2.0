 ...
 * @author hecto
 */
public class frmElegirReportePagos extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReportePagos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReportePagosPendientes = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lblReportePagosPendientes = new javax.swing.JLabel();
        btnReportePagosNoRealizados = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        lblReportePagosNoRealizados = new javax.swing.JLabel();
        ...
        btnReportePagosPendientes.setBackground(new java.awt.Color(102, 0, 0));
        btnReportePagosPendientes.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReportePagosPendientes.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReportePagosPendientes.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnReportePagosPendientesFocusGained(evt);
            }
        });
        btnReportePagosPendientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReportePagosPendientesMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnReportePagosPendientesMouseReleased(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReportePagosPendientesMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReportePagosPendientesMouseEntered(evt);
            }
        });
        btnReportePagosPendientes.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnReportePagosPendientes.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReportePagosPendientes.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReportePagosPendientes.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReportePagosPendientes.setForeground(new java.awt.Color(204, 204, 204));
        lblReportePagosPendientes.setText("Reporte de Pagos Pendientes");
        lblReportePagosPendientes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReportePagosPendientesMousePressed(evt);
            }
        });
        btnReportePagosPendientes.add(lblReportePagosPendientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReportePagosPendientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 300, 50));

        btnReportePagosNoRealizados.setBackground(new java.awt.Color(102, 0, 0));
        btnReportePagosNoRealizados.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReportePagosNoRealizados.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReportePagosNoRealizados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReportePagosNoRealizadosMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReportePagosNoRealizadosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReportePagosNoRealizadosMouseEntered(evt);
            }
        });
        btnReportePagosNoRealizados.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReportePagosNoRealizados.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReportePagosNoRealizados.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReportePagosNoRealizados.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReportePagosNoRealizados.setForeground(new java.awt.Color(204, 204, 204));
        lblReportePagosNoRealizados.setText("Reporte de Pagos No Realizados");
        lblReportePagosNoRealizados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReportePagosNoRealizadosMousePressed(evt);
            }
        });
        btnReportePagosNoRealizados.add(lblReportePagosNoRealizados, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReportePagosNoRealizados, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
        ...
        lbltReporteTotal.setText("Reportes Totales");
    ...
    private void btnReportePagosPendientesFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnReportePagosPendientesFocusGained

    }//GEN-LAST:event_btnReportePagosPendientesFocusGained

    private void btnReportePagosPendientesMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosPendientesMouseEntered
        setColor(btnReportePagosPendientes);
    }//GEN-LAST:event_btnReportePagosPendientesMouseEntered

    private void btnReportePagosPendientesMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosPendientesMouseExited
        resetColor(btnReportePagosPendientes);
    }//GEN-LAST:event_btnReportePagosPendientesMouseExited

    private void btnReportePagosPendientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosPendientesMousePressed
        Map p = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_pagos_pendientes.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Pagos Pendientes");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReportePagosPendientesMousePressed

    private void btnReportePagosPendientesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosPendientesMouseReleased

    }//GEN-LAST:event_btnReportePagosPendientesMouseReleased

    private void btnReportePagosNoRealizadosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosNoRealizadosMouseEntered
        setColor(btnReportePagosNoRealizados);
    }//GEN-LAST:event_btnReportePagosNoRealizadosMouseEntered

    private void btnReportePagosNoRealizadosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosNoRealizadosMouseExited
        resetColor(btnReportePagosNoRealizados);
    }//GEN-LAST:event_btnReportePagosNoRealizadosMouseExited

    private void btnReportePagosNoRealizadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagosNoRealizadosMousePressed
        Map q = new HashMap();
        
        q.put("estado", "Factura Sin Pagar");
        JasperReport report;
        JasperPrint print;
        
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_pagos_norealizados.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Pagos No Realizados");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReportePagosNoRealizadosMousePressed
    ...
    private void btnReporteTotalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteTotalMousePressed
        ...
        p.put("estado", "Pendiente");
        p.put("estado2", "Factura Sin Pagar");
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_pagos_totales.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            
            view.setTitle("Reporte Total de Pagos");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    ...
    private void lblReportePagosNoRealizadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReportePagosNoRealizadosMousePressed
        Map q = new HashMap();
    ...
    }//GEN-LAST:event_lblReportePagosNoRealizadosMousePressed

    private void lblReportePagosPendientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReportePagosPendientesMousePressed
        Map p = new HashMap();
    ...
    }//GEN-LAST:event_lblReportePagosPendientesMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReportePagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReportePagos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnReportePagosNoRealizados;
    public javax.swing.JPanel btnReportePagosPendientes;
    ...
    private javax.swing.JLabel lblReportePagosNoRealizados;
    private javax.swing.JLabel lblReportePagosPendientes;
