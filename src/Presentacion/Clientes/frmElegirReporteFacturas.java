 ...
 * @author hecto
 */
public class frmElegirReporteFacturas extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReporteFacturas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReportePagados = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lblReporteActivo = new javax.swing.JLabel();
        btnReporteNoPagados = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        lblReporteInactivo = new javax.swing.JLabel();
        ...
        btnReportePagados.setBackground(new java.awt.Color(102, 0, 0));
        btnReportePagados.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReportePagados.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReportePagados.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnReportePagadosFocusGained(evt);
            }
        });
        btnReportePagados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReportePagadosMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnReportePagadosMouseReleased(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReportePagadosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReportePagadosMouseEntered(evt);
            }
        });
        btnReportePagados.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnReportePagados.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReportePagados.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReporteActivo.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReporteActivo.setForeground(new java.awt.Color(204, 204, 204));
        lblReporteActivo.setText("Reporte de Facturas Pagadas");
        lblReporteActivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteActivoMousePressed(evt);
            }
        });
        btnReportePagados.add(lblReporteActivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReportePagados, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 300, 50));

        btnReporteNoPagados.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteNoPagados.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteNoPagados.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteNoPagados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteNoPagadosMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteNoPagadosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteNoPagadosMouseEntered(evt);
            }
        });
        btnReporteNoPagados.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReporteNoPagados.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteNoPagados.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReporteInactivo.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReporteInactivo.setForeground(new java.awt.Color(204, 204, 204));
        lblReporteInactivo.setText("Reporte de Facturas No Pagadas");
        lblReporteInactivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteInactivoMousePressed(evt);
            }
        });
        btnReporteNoPagados.add(lblReporteInactivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteNoPagados, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
        ...
        lbltReporteTotal.setText("Reporte de Facturas Totales");
    ...
    private void btnReportePagadosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnReportePagadosFocusGained

    }//GEN-LAST:event_btnReportePagadosFocusGained

    private void btnReportePagadosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagadosMouseEntered
        setColor(btnReportePagados);
    }//GEN-LAST:event_btnReportePagadosMouseEntered

    private void btnReportePagadosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagadosMouseExited
        resetColor(btnReportePagados);
    }//GEN-LAST:event_btnReportePagadosMouseExited

    private void btnReportePagadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagadosMousePressed
        Map p = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_facturas_pagadas.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Facturas Pagadas");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReportePagadosMousePressed

    private void btnReportePagadosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagadosMouseReleased

    }//GEN-LAST:event_btnReportePagadosMouseReleased

    private void btnReporteNoPagadosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteNoPagadosMouseEntered
        setColor(btnReporteNoPagados);
    }//GEN-LAST:event_btnReporteNoPagadosMouseEntered

    private void btnReporteNoPagadosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteNoPagadosMouseExited
        resetColor(btnReporteNoPagados);
    }//GEN-LAST:event_btnReporteNoPagadosMouseExited

    private void btnReporteNoPagadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteNoPagadosMousePressed
        Map q = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_facturas_nopagadas.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Facturas No Pagadas");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteNoPagadosMousePressed
    ...
    private void btnReporteTotalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteTotalMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_facturas_totales.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            
            view.setTitle("Reporte Total de Facturas");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    ...
    private void lblReporteInactivoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteInactivoMousePressed
        Map q = new HashMap();
    ...
    }//GEN-LAST:event_lblReporteInactivoMousePressed

    private void lblReporteActivoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteActivoMousePressed
        Map p = new HashMap();
    ...
    }//GEN-LAST:event_lblReporteActivoMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReporteFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReporteFacturas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnReporteNoPagados;
    public javax.swing.JPanel btnReportePagados;
    ...
    private javax.swing.JLabel lblReporteActivo;
    private javax.swing.JLabel lblReporteInactivo;
