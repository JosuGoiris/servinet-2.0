 ...
 * @author hecto
 */
public class frmElegirReporteServicios extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReporteServicios() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReporteActivos = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lblReporteActivo = new javax.swing.JLabel();
        btnReporteInactivos = new javax.swing.JPanel();
        ...
        btnReporteActivos.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteActivos.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteActivos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteActivos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnReporteActivosFocusGained(evt);
            }
        });
        btnReporteActivos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteActivosMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnReporteActivosMouseReleased(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteActivosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteActivosMouseEntered(evt);
            }
        });
        btnReporteActivos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnReporteActivos.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteActivos.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));
        ...
        lblReporteActivo.setText("Reporte de Servicios Activos");
        lblReporteActivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteActivoMousePressed(evt);
            }
        });
        btnReporteActivos.add(lblReporteActivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteActivos, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 300, 50));

        btnReporteInactivos.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteInactivos.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteInactivos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteInactivos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteInactivosMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteInactivosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteInactivosMouseEntered(evt);
            }
        });
        btnReporteInactivos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReporteInactivos.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteInactivos.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));
        ...
        lblReporteInactivo.setText("Reporte de Servicios Inactivos");
        lblReporteInactivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteInactivoMousePressed(evt);
            }
        });
        btnReporteInactivos.add(lblReporteInactivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteInactivos, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
        ...
        lbltReporteTotal.setText("Reporte de Servicios Totales");
    ...
    private void btnReporteActivosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnReporteActivosFocusGained

    }//GEN-LAST:event_btnReporteActivosFocusGained

    private void btnReporteActivosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteActivosMouseEntered
        setColor(btnReporteActivos);
    }//GEN-LAST:event_btnReporteActivosMouseEntered

    private void btnReporteActivosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteActivosMouseExited
        resetColor(btnReporteActivos);
    }//GEN-LAST:event_btnReporteActivosMouseExited

    private void btnReporteActivosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteActivosMousePressed
        Map p = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_servicios_activos.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Servicios Activos");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteActivosMousePressed

    private void btnReporteActivosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteActivosMouseReleased

    }//GEN-LAST:event_btnReporteActivosMouseReleased

    private void btnReporteInactivosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteInactivosMouseEntered
        setColor(btnReporteInactivos);
    }//GEN-LAST:event_btnReporteInactivosMouseEntered

    private void btnReporteInactivosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteInactivosMouseExited
        resetColor(btnReporteInactivos);
    }//GEN-LAST:event_btnReporteInactivosMouseExited

    private void btnReporteInactivosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteInactivosMousePressed
        Map q = new HashMap();
        
        q.put("estado", "Inactivo");
        JasperReport report;
        JasperPrint print;
        
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_servicios_inactivos.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Servicios Inactivos");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteInactivosMousePressed
    ...
    private void lbltReporteTotalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbltReporteTotalMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_servicios_totales.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            
            view.setTitle("Reporte Total de Servicios");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReporteServicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReporteServicios().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JPanel btnReporteActivos;
    private javax.swing.JPanel btnReporteInactivos;
