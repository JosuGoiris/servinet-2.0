 ...
 * @author hecto
 */
public class frmElegirReporteTrabajosReclamos extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReporteTrabajosReclamos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReporteReclamosSinAtender = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lblReporteReclamosSinAtender = new javax.swing.JLabel();
        btnReporteReclamosTerminados = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        lblReporteReclamosTerminados = new javax.swing.JLabel();
        ...
        btnReporteReclamosSinAtender.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteReclamosSinAtender.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteReclamosSinAtender.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteReclamosSinAtender.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnReporteReclamosSinAtenderFocusGained(evt);
            }
        });
        btnReporteReclamosSinAtender.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteReclamosSinAtenderMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnReporteReclamosSinAtenderMouseReleased(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteReclamosSinAtenderMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteReclamosSinAtenderMouseEntered(evt);
            }
        });
        btnReporteReclamosSinAtender.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnReporteReclamosSinAtender.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteReclamosSinAtender.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReporteReclamosSinAtender.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReporteReclamosSinAtender.setForeground(new java.awt.Color(204, 204, 204));
        lblReporteReclamosSinAtender.setText("Reporte de Reclamos sin Atender");
        lblReporteReclamosSinAtender.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteReclamosSinAtenderMousePressed(evt);
            }
        });
        btnReporteReclamosSinAtender.add(lblReporteReclamosSinAtender, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteReclamosSinAtender, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 300, 50));

        btnReporteReclamosTerminados.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteReclamosTerminados.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteReclamosTerminados.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteReclamosTerminados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteReclamosTerminadosMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteReclamosTerminadosMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteReclamosTerminadosMouseEntered(evt);
            }
        });
        btnReporteReclamosTerminados.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReporteReclamosTerminados.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteReclamosTerminados.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReporteReclamosTerminados.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReporteReclamosTerminados.setForeground(new java.awt.Color(204, 204, 204));
        lblReporteReclamosTerminados.setText("Reporte de Reclamos Terminados");
        lblReporteReclamosTerminados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteReclamosTerminadosMousePressed(evt);
            }
        });
        btnReporteReclamosTerminados.add(lblReporteReclamosTerminados, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteReclamosTerminados, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
    ...
    private void btnReporteReclamosSinAtenderFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnReporteReclamosSinAtenderFocusGained

    }//GEN-LAST:event_btnReporteReclamosSinAtenderFocusGained

    private void btnReporteReclamosSinAtenderMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosSinAtenderMouseEntered
        setColor(btnReporteReclamosSinAtender);
    }//GEN-LAST:event_btnReporteReclamosSinAtenderMouseEntered

    private void btnReporteReclamosSinAtenderMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosSinAtenderMouseExited
        resetColor(btnReporteReclamosSinAtender);
    }//GEN-LAST:event_btnReporteReclamosSinAtenderMouseExited

    private void btnReporteReclamosSinAtenderMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosSinAtenderMousePressed
        Map p = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamo_sinatender.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Reclamos sin Atender");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteReclamosSinAtenderMousePressed

    private void btnReporteReclamosSinAtenderMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosSinAtenderMouseReleased

    }//GEN-LAST:event_btnReporteReclamosSinAtenderMouseReleased

    private void btnReporteReclamosTerminadosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosTerminadosMouseEntered
        setColor(btnReporteReclamosTerminados);
    }//GEN-LAST:event_btnReporteReclamosTerminadosMouseEntered

    private void btnReporteReclamosTerminadosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosTerminadosMouseExited
        resetColor(btnReporteReclamosTerminados);
    }//GEN-LAST:event_btnReporteReclamosTerminadosMouseExited

    private void btnReporteReclamosTerminadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosTerminadosMousePressed
        Map q = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamo_terminado.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Reclamos Terminados");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteReclamosTerminadosMousePressed
    ...
    private void btnReporteTotalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteTotalMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamo_juntos.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
    ...
    private void lblReporteReclamosTerminadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteReclamosTerminadosMousePressed
        Map q = new HashMap();
    ...
    }//GEN-LAST:event_lblReporteReclamosTerminadosMousePressed

    private void lblReporteReclamosSinAtenderMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteReclamosSinAtenderMousePressed
        Map p = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamos_sinatender.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Reclamos sin Atender");
            view.setVisible(true);
    ...
    }//GEN-LAST:event_lblReporteReclamosSinAtenderMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReporteTrabajosReclamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReporteTrabajosReclamos().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JPanel btnReporteReclamosSinAtender;
    private javax.swing.JPanel btnReporteReclamosTerminados;
    ...
    private javax.swing.JLabel lblReporteReclamosSinAtender;
    private javax.swing.JLabel lblReporteReclamosTerminados;
