 ...
 * @author josug
 */
public class frmRevisarSolicitudes extends javax.swing.JFrame {
    ...
    public static int idTrabajosSolicitud;
    ...
    public static Date fechaSolicitud;
    public static Date fechaActualizado;
    ...
    public void ordenartamaños() {
        ...
        Modelo.getColumn(8).setPreferredWidth(60);
        Modelo.getColumn(8).setResizable(false);
    }

  

    public void mostrarSolicitudesPendientes(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarSolicitudesPendientes(buscar);
    ...
    public void mostrarSolicitudesAceptadas(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarSolicitudesAceptadas(buscar);
            tblTrabajos.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void initComponents() {
        ...
        jLabel25.setText("Agregar Cuadrilla");
        ...
        jLabel26.setText("Editar Trabajo");
        ...
        jLabel27.setText("Eliminar Trabajo");
        ...
        jLabel19.setText("REVISAR SOLICITUDES");
        jPanel2.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 250, 50));
    ...
    private void btnAgregarCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarCuadrillaMousePressed
        ...
        if (tblTrabajos.getSelectedRows().length > 0) {
            frmValoresTrabajosNuevo form = new frmValoresTrabajosNuevo();
            accion = "cargar";
            form.cargarValores();
    ...
    private void tblTrabajosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTrabajosMouseClicked
        ...
        idTrabajosSolicitud = Integer.parseInt(tblTrabajos.getValueAt(fila, 0).toString());
        id = tblTrabajos.getValueAt(fila, 0).toString();
        idTrabajos = lt.traerIdTrabajos(idTrabajosSolicitud);
        idSolicitud = lt.traerIdSolicitud(idTrabajosSolicitud);
        idCliente = lt.traerIdCliente(idSolicitud);
        ...
        fechaSolicitud = Date.valueOf(tblTrabajos.getValueAt(fila, 4).toString());
        if(btnEditarSombra.isVisible()){
            fechaActualizado = Date.valueOf(tblTrabajos.getValueAt(fila, 5).toString());
        }
        int idDetalle = lt.traerIdDetalleServicio(idCliente);
        idServicio = lt.traerIdServicio(idDetalle);
        nombreServicio = tblTrabajos.getValueAt(fila, 6).toString();
        cuadrilla = tblTrabajos.getValueAt(fila, 7).toString();
    ...
    private void btnEliminarTrabajoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarTrabajoMousePressed
        ...
        if(!id.equals("")){
            ...
            if(mensaje == 0){
                ...
                LTrabajos fun = new LTrabajos();
                
                dt.setIdTrabajos(idTrabajos);
                dts.setIdTrabajosSolicitud(idTrabajosSolicitud);
                dsc.setIdServiciodelCliente(idCliente);
                ds.setIdSolicitud(idSolicitud);
                fun.eliminarTrabajoSolicitud(ds, dsc, dt, dts);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRevisarSolicitudes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRevisarSolicitudes().setVisible(true);
            }
        });
    }
