...
public class frmElegirReporteSolicitudes extends javax.swing.JFrame {
     ...
     */
    public frmElegirReporteSolicitudes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReporteAceptadas = new javax.swing.JPanel();
        ...
        lblReporteActivo.setText("Reporte de Solicitudes Pendientes");
        ...
        btnReporteAceptadas.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteAceptadas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteAceptadas.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteAceptadas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteAceptadasMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteAceptadasMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteAceptadasMouseEntered(evt);
            }
        });
        btnReporteAceptadas.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReporteAceptadas.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteAceptadas.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));
        ...
        lblReporteInactivo.setText("Reporte de Solicitudes Aceptadas");
        lblReporteInactivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteInactivoMousePressed(evt);
            }
        });
        btnReporteAceptadas.add(lblReporteInactivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteAceptadas, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
    ...
    private void btnReportePagadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportePagadosMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajosolicitud_pendiente.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Trabajos Pendientes");
    ...
    private void btnReporteAceptadasMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteAceptadasMouseEntered
        setColor(btnReporteAceptadas);
    }//GEN-LAST:event_btnReporteAceptadasMouseEntered

    private void btnReporteAceptadasMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteAceptadasMouseExited
        resetColor(btnReporteAceptadas);
    }//GEN-LAST:event_btnReporteAceptadasMouseExited

    private void btnReporteAceptadasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteAceptadasMousePressed
        Map q = new HashMap();
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajosolicitud_aceptado.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Trabajos Aceptados");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteAceptadasMousePressed
    ...
    private void btnReporteTotalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteTotalMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajosolicitud_totales.jrxml");
            print = JasperFillManager.fillReport(report, p, cn);
            JasperViewer view = new JasperViewer(print, false);
            
            view.setTitle("Reporte Total de Trabajos");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReporteSolicitudes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReporteSolicitudes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnReporteAceptadas;
