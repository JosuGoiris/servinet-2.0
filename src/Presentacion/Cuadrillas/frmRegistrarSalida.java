...
import static Presentacion.Cuadrillas.frmRegistrarEntrada.txtHora;
...
public class frmRegistrarSalida extends javax.swing.JFrame {
    ...
    void cargarValores(){
        txtIdTrabajador.setText(String.valueOf(frmRegistrodeTrabajadores.idTrabajador));
        txtNombres.setText(frmRegistrodeTrabajadores.nombres);
        txtApellidos.setText(frmRegistrodeTrabajadores.apellidos);
        txtCedula.setText(frmRegistrodeTrabajadores.nrodeCedula);
        txtIdCuadrilla.setText(String.valueOf(frmRegistrodeTrabajadores.idCuadrilla));
        txtCuadrilla.setText(frmRegistrodeTrabajadores.cuadrilla);
        txtIdPuesto.setText(String.valueOf(frmRegistrodeTrabajadores.idPuesto));
        txtPuesto.setText(frmRegistrodeTrabajadores.puesto);
        txtHora.setText(frmRegistrodeTrabajadores.horaEntrada);
        txtIdDetalleCuadrilla.setText(String.valueOf(frmRegistrodeTrabajadores.idDetalleCuadrilla));
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 120, -1));
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        ...
        dht.setHoraSalida(Time.valueOf(txtHoraSalida.getText()));
        
        int id = lht.traerIdHorario(Integer.parseInt(txtIdDetalleCuadrilla.getText()));
        
        dht.setObservacion(txtObservacion.getText());
        
        dht.setIdHorarioTrabajo(id);

        fun.insertarHorarioSalida(dht);
