 ...
 * @author hecto
 */
public class frmElegirReporteReclamos extends javax.swing.JFrame {

    Connection cn = ConexionSingleton.getConnection();
    /**
     * Creates new form frmElegirReporteSolicitudes
     */
    public frmElegirReporteReclamos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnReporteReclamosRevision = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        lblReporteRevision = new javax.swing.JLabel();
        ...
        btnReporteReclamosRevision.setBackground(new java.awt.Color(102, 0, 0));
        btnReporteReclamosRevision.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnReporteReclamosRevision.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnReporteReclamosRevision.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnReporteReclamosRevisionMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnReporteReclamosRevisionMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnReporteReclamosRevisionMouseEntered(evt);
            }
        });
        btnReporteReclamosRevision.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnReporteReclamosRevision.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnReporteReclamosRevision.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 230, 10));

        lblReporteRevision.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblReporteRevision.setForeground(new java.awt.Color(204, 204, 204));
        lblReporteRevision.setText("Reporte de Reclamos En Revisión");
        lblReporteRevision.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                lblReporteRevisionMousePressed(evt);
            }
        });
        btnReporteReclamosRevision.add(lblReporteRevision, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnReporteReclamosRevision, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 300, 50));
    ...
    private void btnReporteReclamosPendientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosPendientesMousePressed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamo_pendiente.jrxml");
    ...
    private void btnReporteReclamosRevisionMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosRevisionMouseEntered
        setColor(btnReporteReclamosRevision);
    }//GEN-LAST:event_btnReporteReclamosRevisionMouseEntered

    private void btnReporteReclamosRevisionMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosRevisionMouseExited
        resetColor(btnReporteReclamosRevision);
    }//GEN-LAST:event_btnReporteReclamosRevisionMouseExited

    private void btnReporteReclamosRevisionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReporteReclamosRevisionMousePressed
        Map q = new HashMap();
        
        q.put("estado", "En Revisión");
        JasperReport report;
        JasperPrint print;
        
        try {
            report = JasperCompileManager.compileReport(new File("")
                    .getAbsolutePath()+"/src/Reportes/reporte_trabajoreclamo_enrevision.jrxml");;
            print = JasperFillManager.fillReport(report, q, cn);
            JasperViewer view = new JasperViewer(print, false);
            view.setTitle("Reporte de Reclamos En Revision");
            view.setVisible(true);
        } catch (JRException e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_btnReporteReclamosRevisionMousePressed
    ...
    private void lblReporteRevisionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteRevisionMousePressed
        Map q = new HashMap();
    ...
    }//GEN-LAST:event_lblReporteRevisionMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmElegirReporteReclamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmElegirReporteReclamos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnReporteReclamosRevision;
    ...
    private javax.swing.JLabel lblReporteRevision;
