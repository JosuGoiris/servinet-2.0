 ...
 * @author josug
 */
public class frmAtenderReclamos extends javax.swing.JFrame {
     ...
     */
    public frmAtenderReclamos() {
        initComponents();
        mostrarReclamosEnRevision("");
        ordenartamaños();
    ...
    public void ordenartamaños() {
        TableColumnModel Modelo = tblReclamos.getColumnModel();
    ...
    public void mostrarReclamosEnRevision(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarReclamosEnRevision(buscar);
            tblReclamos.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    }

    public void mostrarReclamosTerminados(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarReclamosTerminados(buscar);
            tblReclamos.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void initComponents() {
        ...
        jScrollTrabajos.setViewportView(tblReclamos);
    ...
    private void tblReclamosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblReclamosMouseClicked
        int fila = tblReclamos.rowAtPoint(evt.getPoint());
        idTrabajosReclamos = Integer.parseInt(tblReclamos.getValueAt(fila, 0).toString());
    ...
    private void btnReportesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportesMousePressed
        frmElegirReporteTrabajosReclamos form = new frmElegirReporteTrabajosReclamos();
        form.setVisible(true);
        form.toFront();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAtenderReclamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAtenderReclamos().setVisible(true);
            }
        });
    }
