 ...
 * @author josug
 */
public class frmRevisarTrabajos extends javax.swing.JFrame {
     ...
     */
    public frmRevisarTrabajos() {
        initComponents();
        mostrarSolicitudesTrabajando("");
        ordenartamaños();
    ...
    public void ordenartamaños() {
        TableColumnModel Modelo = tblTrabajo.getColumnModel();
    ...
    public void mostrarSolicitudesTrabajando(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarSolicitudesTrabajando(buscar);
            tblTrabajo.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    }

    public void mostrarSolicitudesTerminadas(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajos log = new LTrabajos();
            miModelo = log.mostrarSolicitudesTerminadas(buscar);
            tblTrabajo.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void initComponents() {
        ...
        btnRealizarTrabajo = new javax.swing.JPanel();
        ...
        btnRealizarTrabajo.setBackground(new java.awt.Color(102, 0, 0));
        btnRealizarTrabajo.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnRealizarTrabajo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnRealizarTrabajoMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnRealizarTrabajoMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnRealizarTrabajoMouseEntered(evt);
            }
        });
        btnRealizarTrabajo.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnRealizarTrabajo.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 31, 36));
        btnRealizarTrabajo.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 37, 246, 10));

        jLabel25.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(204, 204, 204));
        jLabel25.setText("Realizar Trabajo");
        btnRealizarTrabajo.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        jPanel2.add(btnRealizarTrabajo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 240, 50));
        ...
        jPanel2.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 240, 50));
        ...
        jPanel2.add(btnNuevaSolicitud1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 240, 50));
        ...
        jLabel19.setText("TRABAJOS ");
        jPanel2.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 130, 50));
        ...
        jPanel2.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 240, 50));
        ...
        tblTrabajo.setAutoCreateRowSorter(true);
        tblTrabajo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tblTrabajo.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblTrabajo.setGridColor(new java.awt.Color(255, 255, 255));
        tblTrabajo.setRowHeight(25);
        tblTrabajo.setSelectionBackground(new java.awt.Color(153, 0, 0));
        tblTrabajo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTrabajoMouseClicked(evt);
            }
        });
        jScrollTrabajos.setViewportView(tblTrabajo);
        ...
        lblAceptado.setText("ESTADO TERMINADO");
    ...
    private void btnRealizarTrabajoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRealizarTrabajoMousePressed
        int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea realizar el trabajo?");
        if (mensaje == 0) {
            ...
            fun.realizarTrabajos(ds, dsc, dt);
        }
    }//GEN-LAST:event_btnRealizarTrabajoMousePressed

    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed

    }//GEN-LAST:event_jPanel1MousePressed

    private void tblTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTrabajoMouseClicked
        int fila = tblTrabajo.rowAtPoint(evt.getPoint());
        idTrabajosSolicitud = Integer.parseInt(tblTrabajo.getValueAt(fila, 0).toString());
        id = tblTrabajo.getValueAt(fila, 0).toString();
    ...
    }//GEN-LAST:event_tblTrabajoMouseClicked
    ...
    private void btnReportesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnReportesMousePressed
        frmElegirReporteTrabajos form = new frmElegirReporteTrabajos();
        form.setVisible(true);
        form.toFront();
    ...
    private void btnRealizarTrabajoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRealizarTrabajoMouseEntered
        setColor(btnRealizarTrabajo);
    }//GEN-LAST:event_btnRealizarTrabajoMouseEntered

    private void btnRealizarTrabajoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRealizarTrabajoMouseExited
        resetColor(btnRealizarTrabajo);
    }//GEN-LAST:event_btnRealizarTrabajoMouseExited
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRevisarTrabajos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRevisarTrabajos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnRealizarTrabajo;
    ...
    private javax.swing.JTable tblTrabajo;
