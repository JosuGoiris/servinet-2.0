 ...
 * @author jotz
 */
public class frmCuadrillaNuevo extends javax.swing.JFrame {
    ...
    public static String nombreCuadrilla;
    ...
    public void mostrarBuscar(String buscar) {
        try {
            ...
            LCuadrillas log = new LCuadrillas();
            miModelo = log.mostrarCuadrillas(buscar);
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LCuadrillas log = new LCuadrillas();
            miModelo = log.mostrarCuadrillasInactivas(buscar);
            tblCuadrilla.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void ordenarTamaños() {
        TableColumnModel Modelo = tblCuadrilla.getColumnModel();
        ...
        Modelo.getColumn(4).setPreferredWidth(20);
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Agregar Nueva Cuadrilla");
        ...
        lblEliminarServicio.setText("Eliminar Cuadrilla");
        ...
        jLabel23.setText("CUADRILLAS");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 150, 50));
        ...
        jLabel19.setText("Editar Cuadrilla Existente");
        ...
        tblCuadrilla.setSelectionBackground(new java.awt.Color(102, 0, 0));
        tblCuadrilla.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCuadrillaMouseClicked(evt);
            }
        });
    ...
    private void btnEliminarCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarCuadrillaMousePressed
        eliminar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea eliminar la cuadrilla seleccionada?");
            if (mensaje == 0) {
                DCuadrillas dc = new DCuadrillas();
                LCuadrillas fun = new LCuadrillas();

                dc.setIdCuadrilla(idCuadrilla);
                fun.eliminarCuadrilla(dc);
            }
        }
    ...
    private void tblCuadrillaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCuadrillaMouseClicked
        int fila = tblCuadrilla.rowAtPoint(evt.getPoint());
        idCuadrilla = Integer.parseInt(tblCuadrilla.getValueAt(fila, 0).toString());
        id = tblCuadrilla.getValueAt(fila, 0).toString();
        nombreCuadrilla = tblCuadrilla.getValueAt(fila, 1).toString();
        cantidadTrabajadores = Integer.parseInt(tblCuadrilla.getValueAt(fila, 2).toString());
        descripcion = tblCuadrilla.getValueAt(fila, 3).toString();
    }//GEN-LAST:event_tblCuadrillaMouseClicked
    ...
    private void btnVolveraActivarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolveraActivarMousePressed
        activar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea volver a activar la cuadrilla seleccionada?");
            if (mensaje == 0) {
                DCuadrillas dc = new DCuadrillas();
                LCuadrillas fun = new LCuadrillas();

                dc.setIdCuadrilla(idCuadrilla);
                fun.activarCuadrilla(dc);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCuadrillaNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCuadrillaNuevo().setVisible(true);
            }
        });
    }
