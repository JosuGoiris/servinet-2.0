 ...
 * @author josug
 */
public class frmValoresPuestosNuevo extends javax.swing.JFrame {
    ...
    public void cargarValores() {
        if ("si".equals(frmPuestosNuevo.editar)) {
            txtId.setText(String.valueOf(frmPuestosNuevo.idPuesto));
            txtNombrePuesto.setText(frmPuestosNuevo.nombrePuesto);
            txtDescripcion.setText(frmPuestosNuevo.descripcion);
        }
    }
    ...
    private void initComponents() {
        ...
        txtNombrePuesto.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtNombrePuestoFocusLost(evt);
            }
        });
        ...
        jPanel3.add(txtNombrePuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 190, -1));
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        if (txtId.getText().equals("")) {
            ...
            dp.setNombrePuesto(txtNombrePuesto.getText());
            dp.setDescripcion(txtDescripcion.getText());

            fun.insertarPuestos(dp);
            ...
            fun.editarPuestos(dp);
        }
        this.dispose();
    }//GEN-LAST:event_btnGuardarMousePressed

    private void txtNombrePuestoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombrePuestoKeyReleased
        String nombre = (txtNombrePuesto.getText()).toUpperCase();
        txtNombrePuesto.setText(nombre);
    }//GEN-LAST:event_txtNombrePuestoKeyReleased

    private void txtNombrePuestoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNombrePuestoFocusLost
        buscarRepetido();
    }//GEN-LAST:event_txtNombrePuestoFocusLost
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresPuestosNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresPuestosNuevo().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtNombrePuesto;
