 ...
 * @author jotz
 */
public class frmServiciosNuevo extends javax.swing.JFrame {
    ...
    public static int idDetalleServicio;
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LServicios log = new LServicios();
            miModelo = log.mostrarInactivos(buscar);
            tblServicios.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void ordenarTamaños() {
        ...
        Modelo.getColumn(3).setPreferredWidth(20);
        Modelo.getColumn(3).setResizable(false);
        Modelo.getColumn(4).setPreferredWidth(210);
        Modelo.getColumn(4).setResizable(false);
        Modelo.getColumn(5).setPreferredWidth(50);
        Modelo.getColumn(5).setResizable(false);
        Modelo.getColumn(6).setPreferredWidth(20);
    ...
    private void initComponents() {
        ...
        btnEditarServicio = new javax.swing.JPanel();
        ...
        jLabel13.setText("Agregar Nuevo Servicio");
        btnAgregarNuevoServicio.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        ...
        lblEliminarServicio.setText("Eliminar Servicio");
        ...
        jPanel2.add(btnEliminarServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 240, 50));
        ...
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 130, 50));

        btnEditarServicio.setBackground(new java.awt.Color(102, 0, 0));
        btnEditarServicio.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnEditarServicio.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnEditarServicio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnEditarServicioMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnEditarServicioMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnEditarServicioMouseEntered(evt);
            }
        });
        btnEditarServicio.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnEditarServicio.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 12, 31, 36));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(204, 204, 204));
        jLabel19.setText("Editar Servicio Existente");
        btnEditarServicio.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        btnEditarServicio.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 38, 167, 10));

        jPanel2.add(btnEditarServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 240, 50));
        ...
        tblServicios.setSelectionBackground(new java.awt.Color(102, 0, 0));
    ...
    private void btnAgregarNuevoServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoServicioMousePressed
        editar = "no";
        frmValoresServicioNuevo form = new frmValoresServicioNuevo();
    ...
    private void btnEliminarServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarServicioMousePressed
        eliminar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea eliminar el servicio seleccionado?");
            if (mensaje == 0) {
                DDetalleServicio dds = new DDetalleServicio();
                LServicios fun = new LServicios();

                dds.setIdDetalleServicio(idDetalleServicio);
                fun.eliminarServicios(dds);
            }
        }
    ...
    private void btnEditarServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarServicioMousePressed
        editar = "si";
        frmValoresServicioNuevo form = new frmValoresServicioNuevo();
        form.setVisible(true);
        form.toFront();
    }//GEN-LAST:event_btnEditarServicioMousePressed

    private void btnEditarServicioMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarServicioMouseExited
        resetColor(btnEditarServicio);
    }//GEN-LAST:event_btnEditarServicioMouseExited

    private void btnEditarServicioMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarServicioMouseEntered
        setColor(btnEditarServicio);
    }//GEN-LAST:event_btnEditarServicioMouseEntered
    ...
    private void tblServiciosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblServiciosMouseClicked
        ...
        idDetalleServicio = Integer.parseInt(tblServicios.getValueAt(fila, 0).toString());
        id = tblServicios.getValueAt(fila, 0).toString();
        idServicio = ls.traerIdServicio(idDetalleServicio);
        nombre = tblServicios.getValueAt(fila, 1).toString();
        velocidad = tblServicios.getValueAt(fila, 2).toString();
        precio = tblServicios.getValueAt(fila, 3).toString();
        descripcion = tblServicios.getValueAt(fila, 4).toString();
        idZona = ls.traerIdZona(idDetalleServicio);
        nombreZona = tblServicios.getValueAt(fila, 5).toString();
    ...
    private void btnVolveraActivarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolveraActivarMousePressed
        activar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea volver a activar el servicio seleccionado?");
            if (mensaje == 0) {
                DDetalleServicio dds = new DDetalleServicio();
                LServicios fun = new LServicios();

                dds.setIdDetalleServicio(idDetalleServicio);
                fun.activarServicio(dds);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmServiciosNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmServiciosNuevo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnEditarServicio;
