 ...
 * @author jotz
 */
public final class frmUsuarioNuevo extends javax.swing.JFrame {
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LUsuarios log = new LUsuarios();
            miModelo = log.mostrarUsuariosInactivos(buscar);
            tblusuarios.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void ordenarTamaños() {
        TableColumnModel Modelo = tblusuarios.getColumnModel();
        ...
        Modelo.getColumn(9).setPreferredWidth(20);
    ...
    private void initComponents() {
        ...
        lblEliminarServicio.setText("Eliminar Usuario");
        ...
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 120, 50));
        ...
        jLabel19.setText("Editar Usuario Existente");
        ...
        tblusuarios.setSelectionBackground(new java.awt.Color(102, 0, 0));
    ...
    private void btnAgregarNuevoServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoServicioMousePressed
        editar = "no";
        frmValoresUsuarioNuevo form = new frmValoresUsuarioNuevo();
    ...
    private void btnEliminarServicioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarServicioMousePressed
        ...
        if (!id.equals("")) {
            ...
            if (mensaje == 0) {
                ...
                dp.setIdPersona(idUsuario);
                fun.eliminarUsuarios(dp);
            }
        }
    ...
    private void tblusuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblusuariosMouseClicked
        ...
        nombre = tblusuarios.getValueAt(fila, 3).toString();
        apellido = tblusuarios.getValueAt(fila, 4).toString();
