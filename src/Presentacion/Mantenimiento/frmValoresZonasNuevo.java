 ...
 * @author josug
 */
public final class frmValoresZonasNuevo extends javax.swing.JFrame {
    ...
    public void cargarValores(){
        if("si".equals(frmZonaNuevo.editar)){
            txtId.setText(String.valueOf(frmZonaNuevo.idZona));
            txtNombreBarrio.setText(frmZonaNuevo.nombreZona);
            txtDescripcion.setText(frmZonaNuevo.descripcion);
        }
    }
    ...
    private void initComponents() {
        ...
        txtNombreBarrio.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtNombreBarrioKeyReleased(evt);
            }
        });
        jPanel3.add(txtNombreBarrio, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 180, -1));

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Nombre del Barrio:");
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        if(txtId.getText().equals("")){
            ...
            dz.setNombreZona(txtNombreBarrio.getText());
            dz.setDescripcion(txtDescripcion.getText());
            
            fun.insertarZona(dz);
        }else if("si".equals(frmZonaNuevo.editar)){
            DZonas dz = new DZonas();
            LZonas fun = new LZonas();
            
            dz.setIdZona(Integer.parseInt(txtId.getText()));
            dz.setNombreZona(txtNombreBarrio.getText());
            dz.setDescripcion(txtDescripcion.getText());
    ...
    private void txtNombreBarrioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreBarrioKeyTyped
        
    }//GEN-LAST:event_txtNombreBarrioKeyTyped

    private void txtNombreBarrioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreBarrioKeyReleased
        String nombre = txtNombreBarrio.getText().toUpperCase();
        txtNombreBarrio.setText(nombre);
    }//GEN-LAST:event_txtNombreBarrioKeyReleased
    ...
    void buscarRepetido(){
        ...
        String nombre = txtNombreBarrio.getText();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresZonasNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresZonasNuevo().setVisible(true);
            }
        });
    }
