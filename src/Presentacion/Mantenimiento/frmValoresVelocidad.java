 ...
 * @author josug
 */
public class frmValoresVelocidad extends javax.swing.JFrame {
     ...
     */
    public frmValoresVelocidad() {
        initComponents();
        this.setLocationRelativeTo(null);
        
        cmbEstado.setModel(es.llenarComboEstadoVelocidad());
        
        //** Carga de los valores **/
    }
    
    public void cargarValores() {
        frmVelocidadInternet formVelocidad = new frmVelocidadInternet();
        txtId.setText(String.valueOf(formVelocidad.id));
        txtVelocidadCon.setText(formVelocidad.velocidad);
        cmbEstado.setSelectedIndex(0);
    }
    
    public void limpiarCampos(){
        txtId.setText("");
        txtVelocidadCon.setText("");
        cmbEstado.setSelectedIndex(0);
    }
    ...
    private void initComponents() {
        ...
        txtVelocidadCon = new javax.swing.JTextField();
        ...
        jLabel5.setText("Velocidad de Conexión:");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtVelocidadCon, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtVelocidadCon, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21)
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtId.getText().equals("")) {
            DVelocidadInternet dvi = new DVelocidadInternet();
            LVelocidadInternet fun = new LVelocidadInternet();

            String estado = String.valueOf(cmbEstado.getSelectedItem());
            dvi.setVelocidad(txtVelocidadCon.getText() + " MB");
            dvi.setEstadovelocidadId(Integer.parseInt(txtIdEstado.getText()));
            msg = fun.insertarVelocidad(dvi);
            if(msg == "si") {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresVelocidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresVelocidad().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtVelocidadCon;
