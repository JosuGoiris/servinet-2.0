 ...
 * @author josug
 */
public final class frmVistaDireccionUsuario extends javax.swing.JFrame {
    ...
    public frmVistaDireccionUsuario() {
        initComponents();
        this.setLocationRelativeTo(null);
        mostrar(0);
        ordenarTamaños();
        txtBuscar.setText(frmValoresUsuarioNuevo.barrio);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaDireccionUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaDireccionUsuario().setVisible(true);
            }
        });
    }
