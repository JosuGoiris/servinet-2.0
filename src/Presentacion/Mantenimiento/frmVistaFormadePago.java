...
import Presentacion.Clientes.frmGenerarPago;
 ...
 * @author josug
 */
public class frmVistaFormadePago extends javax.swing.JFrame {

    /**
     * Creates new form frmVistaZonaNuevo
     */
    public frmVistaFormadePago() {
        initComponents();
    ...
    public void mostrar(String buscar) {
        try {
            ...
            miModelo = fun.mostrarFormasMini(buscar);
    ...
    private void initComponents() {
        ...
        tblFormadePago.setSelectionBackground(new java.awt.Color(122, 72, 221));
        tblFormadePago.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tblFormadePagoMousePressed(evt);
            }
        });
    ...
    private void tblFormadePagoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblFormadePagoMousePressed
        if (evt.getClickCount() == 2) {
            int fila = tblFormadePago.getSelectedRow();
            String cod, nombre;
            cod = tblFormadePago.getValueAt(fila, 0).toString();
            nombre = tblFormadePago.getValueAt(fila, 1).toString();

            frmGenerarPago.txtIdFormadePago.setText(cod);
            frmGenerarPago.txtForma.setText(nombre);
            this.dispose();
        }
    }//GEN-LAST:event_tblFormadePagoMousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaFormadePago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaFormadePago().setVisible(true);
            }
        });
    }
