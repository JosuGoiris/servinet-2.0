 ...
 * @author josug
 */
public class frmVistaCuadrillaNuevo extends javax.swing.JFrame {

    /**
     * Creates new form frmVistaZonaNuevo
     */
    public frmVistaCuadrillaNuevo() {
        initComponents();
    ...
    private void tblCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCuadrillaMousePressed
        if(evt.getClickCount() == 2){
            ...
            }else if(frmValoresTrabajosNuevo.control == 2){
                frmValoresTrabajosNuevo.txtIdCuadrilla.setText(cod);
                frmValoresTrabajosNuevo.txtCuadrilla.setText(nombre);
            }else if(frmValoresAtenderReclamos.control == 3){
                frmValoresAtenderReclamos.txtIdCuadrilla.setText(cod);
                frmValoresAtenderReclamos.txtCuadrilla.setText(nombre);
            }
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaCuadrillaNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaCuadrillaNuevo().setVisible(true);
            }
        });
    }
