 ...
 * @author josug
 */
public final class frmVistaDireccionNuevo extends javax.swing.JFrame {
    ...
    public void mostrar(int id){
        id = frmValoresSolicitudNuevo.idBarrio;
        try {
    ...
    private void tblDireccionesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDireccionesMousePressed
        if(evt.getClickCount() == 2){
            ...
            if(frmValoresDireccionNuevo.control == 1){
                ...
                frmValoresSolicitudNuevo.txtIdDireccion.setText(cod);
                frmValoresSolicitudNuevo.txtDireccion.setText(nombre);
            }else if(frmValoresUsuarioNuevo.control == 3){
                frmValoresUsuarioNuevo.txtIdDireccion.setText(cod);
                frmValoresUsuarioNuevo.txtDireccion.setText(nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaDireccionNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaDireccionNuevo().setVisible(true);
            }
        });
    }
