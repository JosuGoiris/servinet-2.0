 ...
 * @author josug
 */
public class frmVistaCuadrillaConfiguracion extends javax.swing.JFrame {

    public static String cod, nombre;
    
    /**
     * Creates new form frmVistaZonaNuevo
     */
    public frmVistaCuadrillaConfiguracion() {
        initComponents();
    ...
    private void tblCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCuadrillaMousePressed
        if (evt.getClickCount() == 2) {
            ...
            frmValoresConfiguracion.txtIdBarrio.setText(cod);
            frmValoresConfiguracion.txtBarrio.setText(nombre);
            frmValoresConfiguracion.idCuadrilla = cod;
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaCuadrillaConfiguracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaCuadrillaConfiguracion().setVisible(true);
            }
        });
    }
