 ...
 * @author josug
 */
public class frmTipoServicio extends javax.swing.JFrame {
    ...
    public void mostrarBuscar(String buscar){
        try {
            ...
            LTipoServicio log = new LTipoServicio();
            miModelo = log.mostrarTipoServicio(buscar);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        frmValoresTipoServicio formulario = new frmValoresTipoServicio();
    ...
    private void tblTipoUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTipoUsuarioMouseClicked
        ...
        tipoServicio = tblTipoUsuario.getValueAt(fila, 1).toString();
