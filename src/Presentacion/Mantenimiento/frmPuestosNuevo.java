...
import static Presentacion.Mantenimiento.frmValoresPuestosNuevo.txtNombrePuesto;
 ...
 * @author jotz
 */
public class frmPuestosNuevo extends javax.swing.JFrame {
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LPuestos log = new LPuestos();
            miModelo = log.mostrarPuestosInactivos(buscar);
            tblPuesto.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void ordenarTamaños() {
        TableColumnModel Modelo = tblPuesto.getColumnModel();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Agregar Nuevo Puesto");
        ...
        lblEliminarServicio.setText("Eliminar Puesto");
        ...
        jLabel23.setFont(new java.awt.Font("Bauhaus 93", 1, 18)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(204, 204, 204));
        jLabel23.setText("PUESTOS DE TRABAJADORES");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 250, 50));
        ...
        jLabel19.setText("Editar Puesto Existente");
        ...
        mover.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 10, 30, 30));
        ...
        mover.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 20, 30, 30));
        ...
        mover.add(btnMini, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 30, 30));
        ...
        mover.add(jPanel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, 30, 30));

        jPanel1.add(mover, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 60));
        ...
        jPanel3.add(btnReportes, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, 170, 40));
        ...
        jPanel3.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 170, 40));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 560, 80));
        ...
        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 120, 110, 470));
        ...
        jPanel1.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 530, 550, 60));

        jScrollPane1.setBorder(null);

        tblPuesto.setAutoCreateRowSorter(true);
        tblPuesto.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tblPuesto.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblPuesto.setGridColor(new java.awt.Color(255, 255, 255));
        tblPuesto.setRowHeight(25);
        tblPuesto.setSelectionBackground(new java.awt.Color(102, 0, 0));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 420, 370));
    ...
    private void btnAgregarNuevaCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevaCuadrillaMousePressed
        editar = "no";
        frmValoresPuestosNuevo form = new frmValoresPuestosNuevo();
    ...
    private void btnEliminarCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarCuadrillaMousePressed
        eliminar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea eliminar el puesto seleccionada?");
            if (mensaje == 0) {
                DPuestos dp = new DPuestos();
                LPuestos fun = new LPuestos();

                dp.setIdPuestoTrabajo(idPuesto);
                fun.eliminarPuesto(dp);
            }
        }
    ...
    private void tblPuestoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPuestoMouseClicked
        int fila = tblPuesto.rowAtPoint(evt.getPoint());
        idPuesto = Integer.parseInt(tblPuesto.getValueAt(fila, 0).toString());
        id = tblPuesto.getValueAt(fila, 0).toString();
        nombrePuesto = tblPuesto.getValueAt(fila, 1).toString();
        descripcion = tblPuesto.getValueAt(fila, 2).toString();
    ...
    private void btnVolveraActivarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolveraActivarMousePressed
        activar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea volver a activar el puesto seleccionada?");
            if (mensaje == 0) {
                DPuestos dp = new DPuestos();
                LPuestos fun = new LPuestos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPuestosNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPuestosNuevo().setVisible(true);
            }
        });
    }
