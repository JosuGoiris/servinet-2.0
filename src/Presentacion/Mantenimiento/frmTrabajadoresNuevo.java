 ...
 * @author jotz
 */
public class frmTrabajadoresNuevo extends javax.swing.JFrame {
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LTrabajadores log = new LTrabajadores();
            miModelo = log.mostrarTrabajadoresInactivos(buscar);
            tblTrabajador.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void initComponents() {
        ...
        btnAgregarNuevoTrabajador = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        btnEliminarTrabajador = new javax.swing.JPanel();
        ...
        btnEditarTrabajador = new javax.swing.JPanel();
        ...
        btnAgregarNuevoTrabajador.setBackground(new java.awt.Color(102, 0, 0));
        btnAgregarNuevoTrabajador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnAgregarNuevoTrabajador.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnAgregarNuevoTrabajador.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnAgregarNuevoTrabajadorFocusGained(evt);
            }
        });
        btnAgregarNuevoTrabajador.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnAgregarNuevoTrabajadorMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnAgregarNuevoTrabajadorMouseReleased(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnAgregarNuevoTrabajadorMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnAgregarNuevoTrabajadorMouseEntered(evt);
            }
        });
        btnAgregarNuevoTrabajador.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_plus_math_30px_1.png"))); // NOI18N
        btnAgregarNuevoTrabajador.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 12, 31, 36));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(204, 204, 204));
        jLabel13.setText("Agregar N. Trabajador");
        btnAgregarNuevoTrabajador.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        btnAgregarNuevoTrabajador.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 38, 167, 10));

        jPanel2.add(btnAgregarNuevoTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 240, 50));

        btnEliminarTrabajador.setBackground(new java.awt.Color(102, 0, 0));
        btnEliminarTrabajador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnEliminarTrabajador.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnEliminarTrabajador.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnEliminarTrabajadorMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnEliminarTrabajadorMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnEliminarTrabajadorMouseEntered(evt);
            }
        });
        btnEliminarTrabajador.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_trash_30px.png"))); // NOI18N
        btnEliminarTrabajador.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 12, 31, 36));
        ...
        lblEliminarServicio.setText("Eliminar Trabajador");
        btnEliminarTrabajador.add(lblEliminarServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        btnEliminarTrabajador.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 38, 167, 10));

        jPanel2.add(btnEliminarTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 240, 50));
        ...
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 180, 50));

        btnEditarTrabajador.setBackground(new java.awt.Color(102, 0, 0));
        btnEditarTrabajador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnEditarTrabajador.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnEditarTrabajador.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnEditarTrabajadorMousePressed(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnEditarTrabajadorMouseExited(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnEditarTrabajadorMouseEntered(evt);
            }
        });
        btnEditarTrabajador.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_edit_30px.png"))); // NOI18N
        btnEditarTrabajador.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 12, 31, 36));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(204, 204, 204));
        jLabel19.setText("Editar Trab. Existente");
        btnEditarTrabajador.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        btnEditarTrabajador.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 38, 167, 10));

        jPanel2.add(btnEditarTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 240, 50));
        ...
        tblTrabajador.setAutoCreateRowSorter(true);
        tblTrabajador.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tblTrabajador.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblTrabajador.setGridColor(new java.awt.Color(255, 255, 255));
        tblTrabajador.setRowHeight(25);
        tblTrabajador.setSelectionBackground(new java.awt.Color(102, 0, 0));
    ...
    private void btnAgregarNuevoTrabajadorFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnAgregarNuevoTrabajadorFocusGained

    }//GEN-LAST:event_btnAgregarNuevoTrabajadorFocusGained

    private void btnAgregarNuevoTrabajadorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoTrabajadorMousePressed
        editar = "no";
        frmValoresTrabajadoresNuevo form = new frmValoresTrabajadoresNuevo();
        form.setVisible(true);
        form.toFront();
    }//GEN-LAST:event_btnAgregarNuevoTrabajadorMousePressed

    private void btnAgregarNuevoTrabajadorMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoTrabajadorMouseReleased

    }//GEN-LAST:event_btnAgregarNuevoTrabajadorMouseReleased

    private void btnAgregarNuevoTrabajadorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoTrabajadorMouseExited
        resetColor(btnAgregarNuevoTrabajador);
    }//GEN-LAST:event_btnAgregarNuevoTrabajadorMouseExited

    private void btnAgregarNuevoTrabajadorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevoTrabajadorMouseEntered
        setColor(btnAgregarNuevoTrabajador);
    }//GEN-LAST:event_btnAgregarNuevoTrabajadorMouseEntered

    private void btnEliminarTrabajadorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarTrabajadorMousePressed
        eliminar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea eliminar el trabajador seleccionado?");
            if (mensaje == 0) {
                DPersona dp = new DPersona();
                LTrabajadores fun = new LTrabajadores();

                dp.setIdPersona(idTrabajador);
                fun.eliminarTrabajador(dp);
            }
        }

    }//GEN-LAST:event_btnEliminarTrabajadorMousePressed

    private void btnEliminarTrabajadorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarTrabajadorMouseExited
        resetColor(btnEliminarTrabajador);
    }//GEN-LAST:event_btnEliminarTrabajadorMouseExited

    private void btnEliminarTrabajadorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarTrabajadorMouseEntered
        setColor(btnEliminarTrabajador);
    }//GEN-LAST:event_btnEliminarTrabajadorMouseEntered
    ...
    private void btnEditarTrabajadorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarTrabajadorMousePressed
        editar = "si";
        frmValoresTrabajadoresNuevo form = new frmValoresTrabajadoresNuevo();
        form.setVisible(true);
        form.toFront();
    }//GEN-LAST:event_btnEditarTrabajadorMousePressed

    private void btnEditarTrabajadorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarTrabajadorMouseExited
        resetColor(btnEditarTrabajador);
    }//GEN-LAST:event_btnEditarTrabajadorMouseExited

    private void btnEditarTrabajadorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarTrabajadorMouseEntered
        setColor(btnEditarTrabajador);
    }//GEN-LAST:event_btnEditarTrabajadorMouseEntered
    ...
    private void tblTrabajadorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTrabajadorMouseClicked
        ...
        idTrabajador = Integer.parseInt(tblTrabajador.getValueAt(fila, 0).toString());
        id = tblTrabajador.getValueAt(fila, 0).toString();
        nombre = tblTrabajador.getValueAt(fila, 1).toString();
        apellido = tblTrabajador.getValueAt(fila, 2).toString();
        cedula = tblTrabajador.getValueAt(fila, 3).toString();
        telefono = tblTrabajador.getValueAt(fila, 4).toString();
        idDireccion = lt.traerIdDireccion(idTrabajador);
        direccion = tblTrabajador.getValueAt(fila, 5).toString();
        idPuesto = lt.traerIdPuesto(idTrabajador);
        puesto = tblTrabajador.getValueAt(fila, 6).toString();
    ...
    private void btnVolveraActivarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolveraActivarMousePressed
        activar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea volver a activar al trabajador seleccionado?");
            if (mensaje == 0) {
                DPersona dp = new DPersona();
                LTrabajadores fun = new LTrabajadores();

                dp.setIdPersona(idTrabajador);
                fun.activarTrabajador(dp);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTrabajadoresNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTrabajadoresNuevo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel btnAgregarNuevoTrabajador;
    private javax.swing.JPanel btnBuscar;
    private javax.swing.JPanel btnEditarTrabajador;
    private javax.swing.JPanel btnEliminarServicioSombra;
    private javax.swing.JPanel btnEliminarTrabajador;
