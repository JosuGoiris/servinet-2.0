 ...
 * @author josug
 */
public class frmValoresZonas extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtZona, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtId.getText().equals("")) {
            ...
            dz.setNombreZona(txtZona.getText());
            dz.setDescripcion(txtDescripcion.getText());
            dz.setEstadozonaId(Integer.parseInt(txtIdEstado.getText()));
            msg = fun.insertarZona(dz);
            if(msg == "si") {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresZonas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresZonas().setVisible(true);
            }
        });
    }
