 ...
 * @author josug
 */
public class frmValoresTipoUsuarioNuevo extends javax.swing.JFrame {
     ...
     */
    public frmValoresTipoUsuarioNuevo() {
        initComponents();
    ...
    public void cargarValores(){
        if("si".equals(frmTipoUsuarioNuevo.editar)){
            txtId.setText(String.valueOf(frmTipoUsuarioNuevo.idTipo));
            txtNombreTipo.setText(frmTipoUsuarioNuevo.nombreTipo);
            txtDescripcion.setText(frmTipoUsuarioNuevo.descripcion);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3.add(txtNombreTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 200, -1));

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Nombre del Tipo de Usuario:");
    ...
    private void btnGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMousePressed
        if(txtId.getText().equals("")){
            ...
            dtu.setNombre(txtNombreTipo.getText());
            dtu.setDescripcion(txtDescripcion.getText());
            
            fun.insertarTipos(dtu);
            
        }else if("si".equals(frmTipoUsuarioNuevo.editar)){
            DTipoUsuario dtu = new DTipoUsuario();
            LTipoUsuario fun = new LTipoUsuario();
    ...
    private void txtNombreTipoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreTipoKeyReleased
        String nombre = txtNombreTipo.getText().toUpperCase();
        txtNombreTipo.setText(nombre);
    ...
    void buscarRepetido(){
        LTipoUsuario ltu = new LTipoUsuario();
        String nombre = txtNombreTipo.getText();
        try {
            ResultSet rs = ltu.buscarRepetido(nombre);
            if(!rs.next()){
                
            }else{
                JOptionPane.showMessageDialog(rootPane, "Ya existe el tipo de usuario");
                txtNombreTipo.requestFocus();
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresTipoUsuarioNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresTipoUsuarioNuevo().setVisible(true);
            }
        });
    }
