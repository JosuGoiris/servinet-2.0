 ...
 * @author josug
 */
public class frmValoresDireccion extends javax.swing.JFrame {
    ...
    public void cargarValores() {
        frmDireccion formDireccion = new frmDireccion();
        txtId.setText(String.valueOf(formDireccion.id));
        txtDireccion.setText(formDireccion.direccion);
        txtDescripcion.setText(formDireccion.descripcion);
        txtIdZona.setText(formDireccion.zonaId);
        txtnombreZona.setText(formDireccion.zona);
    ...
    private void initComponents() {
        ...
        btnBuscarZona.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscarZonaActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtIdZona, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtnombreZona, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnBuscarZona, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnBuscarZona, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5)
                    .addComponent(jLabel10))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtId.getText().equals("")) {
            ...
            dd.setNombreDireccion(txtDireccion.getText());
            dd.setDescripcion(txtDescripcion.getText());
            dd.setEstadodireccionId(Integer.parseInt(txtIdEstado.getText()));
            dd.setZonaId(Integer.parseInt(txtIdZona.getText()));
            msg = fun.insertarDireccion(dd);
            if(msg == "si") {
        ...
        frmDireccion form = new frmDireccion();
        form.mostrarBuscar("");
        this.dispose();
    }//GEN-LAST:event_btnGuardarActionPerformed

    private void btnBuscarZonaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarZonaActionPerformed
        frmVistaTipoServicio form = new frmVistaTipoServicio();
        form.setVisible(true);
        form.toFront();
        control = 1;
    }//GEN-LAST:event_btnBuscarZonaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmValoresDireccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmValoresDireccion().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnBuscarZona;
    ...
    public static javax.swing.JTextField txtIdZona;
    public static javax.swing.JTextField txtnombreZona;
