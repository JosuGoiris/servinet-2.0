 ...
 * @author jotz
 */
public class frmZonaNuevo extends javax.swing.JFrame {
    ...
    public static int idZona;
    public static String id;
    public static String nombreZona;
    ...
    public void mostrarInactivos(String buscar) {
        try {
            DefaultTableModel miModelo;
            LZonas log = new LZonas();
            miModelo = log.mostrarZonasInactivos(buscar);
            tblBarrio.setModel(miModelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void ordenarTamaños() {
        TableColumnModel Modelo = tblBarrio.getColumnModel();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Agregar Nuevo Barrio");
        btnAgregarNuevaCuadrilla.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        ...
        lblEliminarServicio.setText("Eliminar Barrio");
        btnEliminarCuadrilla.add(lblEliminarServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        ...
        jLabel23.setText("BARRIOS");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 100, 50));
        ...
        jLabel19.setText("Editar Barrio Existente");
        btnEditarCuadrilla.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 12, -1, -1));
        ...
        tblBarrio.setAutoCreateRowSorter(true);
        tblBarrio.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tblBarrio.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        tblBarrio.setGridColor(new java.awt.Color(255, 255, 255));
        tblBarrio.setRowHeight(25);
        tblBarrio.setSelectionBackground(new java.awt.Color(102, 0, 0));
        tblBarrio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblBarrioMouseClicked(evt);
            }
        });
    ...
    private void btnAgregarNuevaCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarNuevaCuadrillaMousePressed
        editar = "no";
        frmValoresZonasNuevo form = new frmValoresZonasNuevo();
    ...
    private void btnEliminarCuadrillaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarCuadrillaMousePressed
        eliminar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea eliminar la zona seleccionada?");
            if (mensaje == 0) {
                DZonas dz = new DZonas();
    ...
    private void tblBarrioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBarrioMouseClicked
        int fila = tblBarrio.rowAtPoint(evt.getPoint());
        idZona = Integer.parseInt(tblBarrio.getValueAt(fila, 0).toString());
        id = tblBarrio.getValueAt(fila, 0).toString();
        nombreZona = tblBarrio.getValueAt(fila, 1).toString();
        descripcion = tblBarrio.getValueAt(fila, 2).toString();
    }//GEN-LAST:event_tblBarrioMouseClicked
    ...
    private void btnVolveraActivarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolveraActivarMousePressed
        activar = "si";
        if (!id.equals("")) {
            int mensaje = JOptionPane.showConfirmDialog(rootPane, "¿Desea volver a activar la zona seleccionada?");
            if (mensaje == 0) {
                DZonas dz = new DZonas();
                LZonas fun = new LZonas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmZonaNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmZonaNuevo().setVisible(true);
            }
        });
    }
