...
public class frmVistaTrabajador extends javax.swing.JFrame {
    ...
    private void tblTrabajadoresMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTrabajadoresMousePressed
        /*if(evt.getClickCount() == 2){
            ...
            String cod, nombre, apellido, todo;
            cod = tblTrabajadores.getValueAt(fila, 0).toString();
            nombre = tblTrabajadores.getValueAt(fila, 1).toString();
            apellido = tblTrabajadores.getValueAt(fila, 2).toString();
            if(frmVerCuadrillas.control == 1){
                frmVerCuadrillas.txtIdTrabajador.setText(cod);
                frmVerCuadrillas.txtNombreTrabajador.setText(nombre);
                frmVerCuadrillas.txtApellidoTrabajador.setText(apellido);
            }
            this.dispose();
        }*/
